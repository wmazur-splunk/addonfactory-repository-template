...
then
    ...
    poetry init -n --author "Splunk Inc, <sales@splunk.com>" --python "^3.7" -l "Splunk-1-2021"
    ...
    gh repo create $REPOORG/$REPO --confirm --$REPOVISIBILITY
    ...
    gh api orgs/$REPOORG/$REPO -X PATCH --field default_branch=$BRANCH
