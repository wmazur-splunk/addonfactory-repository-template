...
then
    ...
    ( git checkout test/wfe-test-ui-mod-do-not-delete-02-09  && git checkout main && git branch -D test/wfe-test-ui-mod-do-not-delete-02-09 ) || true
    git checkout -B "test/wfe-test-ui-mod-do-not-delete-02-09" main
    ...
    git push -f --set-upstream origin test/wfe-test-ui-mod-do-not-delete-02-09 || exit 1
    # gh pr create \
