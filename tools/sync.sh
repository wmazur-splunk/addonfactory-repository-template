...
then
    ...
    ( git checkout feat/13-09-configurable-github-environment && git checkout main && git branch -D feat/13-09-configurable-github-environment) || true
    git checkout -B "feat/13-09-configurable-github-environment" main
    ...
    git push -f --set-upstream origin feat/13-09-configurable-github-environment|| exit 1
#    gh pr create \
