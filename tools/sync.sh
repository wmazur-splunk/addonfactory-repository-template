...
then
    ...
    ( git checkout test/wfe-test  && git checkout main && git branch -D test/wfe-test ) || true
    git checkout -B "test/wfe-test" main
    ...
    git push -f --set-upstream origin test/wfe-test || exit 1
    # gh pr create \
